...
- [ ] Implement the pinned DevCloud AMDGPU driver installation:
    ...
    - Install `amdgpu-dkms` version `6.16.13.30300300-2327507.24.04` together with the headers and modules-extra package for the running kernel. Install versioned `amd-smi-lib7.2.3` version `26.2.2.70203-90~24.04`, rather than introducing the unversioned ROCm package line. These are the exact Noble package versions observed in the pinned AMD 7.2.3 repositories on 2026-09-12.
