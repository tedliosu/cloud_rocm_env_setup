...
export ROCM_DS_CMAKE_REPO_LOCAL_DIRNAME="local_rocm_ds_cmake_vald_repo"
...
export ROCM_DS_CMAKE_HIPCXX_PATCH_RELPATH="${_PATCHES_DIR_RELPATH}/rocm-ds-cmake-libhipcxx-pin.patch"
...
export ROCM_DS_CMAKE_REPO_UPSTREAM_COMMIT="3d18139480d28a77ea0b2e5980f2d2317a114a91"
