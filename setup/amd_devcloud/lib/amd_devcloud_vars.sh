...
readonly AMD_DEVCLOUD_EXPECTED_DISTRO_CODENAME="noble"
...
readonly AMD_DEVCLOUD_PYTORCH_ROCM_WHEEL_VERSION="7.2"
...
readonly AMD_DEVCLOUD_PACKAGED_RAPIDS_STAGE_NAME="install_amd_devcloud_packaged_rapids_environment"
